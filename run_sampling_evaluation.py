...
if __name__ == "__main__":
    ...
    x_train, y_train, x_val, y_val, x_test, y_test, _ , samples_df_train, birdnet_scores_train,  wabad_train_set_size, esc50_set_size = import_dataset(bird_list_index)
    ...
    #save results
    with open(os.path.join(CONFIG["results_path"],"results_sampling_evaluation_new.pkl"), "wb") as file:
